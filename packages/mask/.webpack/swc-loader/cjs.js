const loaderUtils = require('../../../../node_modules/.pnpm/swc-loader@0.1.15_@swc+core@1.2.111+webpack@5.64.1/node_modules/loader-utils')

function makeLoader() {
    return function (source, inputSourceMap) {
        const swc = import('https://x.nest.land/swc@0.1.4/mod.ts')
        ...
        swc.then(({ transform }) => {
            const output = transform(source, programmaticOptions)
